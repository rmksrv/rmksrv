...
<div class="loading-animation" class:hide={!showLoading}>
  <svg
...
<style>
  .loading-animation {
    @apply fixed top-0 right-0 bottom-0 left-0 w-full h-full grid place-items-center bg-white z-50;
  }
  .hide {
    @apply hidden;
  }
